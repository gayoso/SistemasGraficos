...
Cabina.cabinaParedAncha = function(){
	pared_grande_arriba = new Mesh(new Cuadrado());
	mat_pared_grande_arriba = mat4.create();
	...
	pared_grande_arriba.setTransform(mat_pared_grande_arriba);
	
	pared_grande_abajo = new Mesh(new Cuadrado());
	mat_pared_grande_abajo = mat4.create();
	...
	pared_grande_abajo.setTransform(mat_pared_grande_abajo);
	
	pared_grande_izq = new Mesh(new Cuadrado());
	mat_pared_grande_izq = mat4.create();
	...
	pared_grande_izq.setTransform(mat_pared_grande_izq);
	
	pared_grande_der = new Mesh(new Cuadrado());
	mat_pared_grande_der = mat4.create();
	...
	pared_grande_der.setTransform(mat_pared_grande_der);
	
	pared_grande = new Conjunto();
	...
	pared_grande.setTransform(mat_centrar);
	
	pared_grande_ret = new Conjunto();
...
Cabina.cabinaParedes = function(pared_grande1, pared_grande2, pared_chica1, pared_chica2){
	...
	pared_chica2.setTransform(mat_chica2);
	
	paredes = new Conjunto();
	...
	mat_centrar = mat4.create();
	mat4.translate(mat_centrar, mat_centrar, centro);
	paredes.setTransform(mat_centrar);
	
	return paredes;
}

Cabina.cabinaTecho = function(){
	rect_largo_izq = new Mesh( new Cuadrado() );
	mat_rect_largo_izq = mat4.create();
	...
	rect_largo_izq.setTransform(mat_rect_largo_izq);
	
	rect_largo_der = new Mesh( new Cuadrado() );
	mat_rect_largo_der = mat4.create();
	...
	rect_largo_der.setTransform(mat_rect_largo_der);
	
	rect_largo_adelante = new Mesh( new Cuadrado() );
	mat_rect_largo_adelante = mat4.create();
	...
	rect_largo_adelante.setTransform(mat_rect_largo_adelante);
	
	rect_largo_atras = new Mesh( new Cuadrado() );
	mat_rect_largo_atras = mat4.create();
	...
	rect_largo_atras.setTransform(mat_rect_largo_atras);
	
	triang1 = new Mesh( new Triangulo() );
	mat_triang1 = mat4.create();
	...
	triang1.setTransform(mat_triang1);
	
	triang2 = new Mesh( new Triangulo() );
	mat_triang2 = mat4.create();
	...
	triang2.setTransform(mat_triang2);
	
	triang3 = new Mesh( new Triangulo() );
	mat_triang3 = mat4.create();
	...
	triang3.setTransform(mat_triang3);
	
	triang4 = new Mesh( new Triangulo() );
	mat_triang4 = mat4.create();
	...
	triang4.setTransform(mat_triang4);
...
Cabina.cabinaTechoParedes = function(paredes, techo){
	...
	techo.setTransform(mat_t);
	
	paredes_techo = new Conjunto();
...
Cabina.cabinaPiso = function(piso_izq, piso_der, piso_atras, piso_adelante, piso_plano){
	...
	piso_adelante.setTransform(mat_adelante);

	if(piso_plano === undefined) piso_plano = new Mesh( new Cuadrado() );
	mat_plano = mat4.create();
	...
	piso_plano.setTransform(mat_plano);
