...
Conjunto.prototype = {
	...
	applyMatrix = function(m){
		...
		this.matrix.multiply(this.matrix, this.matrix, m);
	},
	...
	updateMatrix = function(){
		if(this.parent === null){
			this.matrix_total.copy(this.matrix);
		} else {
			// ver si esto esta bien, o la mult es al reves
			this.matrix_total.multiply(this.matrix_total, this.parent.matrix_total, this.matrix_total);
		}
